...
**Recommended scope** (from the [Mission 001
report](../missions/001-bootstrap/report.md)):

- Create the Researcher agent definition — the first mission that actually
  needs an agent file, per Principles §7.
- Define selection criteria for the benchmark app *before* evaluating
  candidates (Principles §5: evidence beats opinion).
- Evaluate a small set of candidate apps (suggest 3–5) against those
...
*(empty — added as missions surface new work)*
